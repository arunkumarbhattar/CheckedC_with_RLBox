...
static int _isip(const char *what : itype(_Ptr<const char>));
...
char *resolver_getname(const char *ip : itype(_Ptr<const char>), char *buff : itype(_Ptr<char>), int len) : itype(_Ptr<char>)
{
...
char *resolver_getip(const char *name : itype(_Ptr<const char>), char *buff : itype(_Ptr<char>), int len) : itype(_Ptr<char>)
{
