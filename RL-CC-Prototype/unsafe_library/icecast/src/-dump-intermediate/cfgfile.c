...
static void _parse_root(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_limits(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_directory(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_paths(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_logging(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_security(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_authentication(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_http_headers(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<_Ptr<ice_config_http_header_t>> http_headers);
static void _parse_relay(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_mount(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _parse_listen_socket(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
static void _add_server(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> c);
...
void config_init_configuration(ice_config_t *configuration : itype(_Ptr<ice_config_t>))
{
    ...
    _set_defaults(_Assume_bounds_cast<_Ptr<ice_config_t>>(configuration));
}
...
int config_initial_parse_file(_Ptr<const char> filename)
{
...
int config_parse_file(const char *filename : itype(_Ptr<const char>), _Ptr<ice_config_t> configuration)
{
    xmlDocPtr doc;
    xmlNodePtr node;
...
static void _parse_root(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_limits(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_mount(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_relay(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_listen_socket(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_authentication(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    do {
        if (node == NULL) break;
        if (xmlIsBlankNode(node)) continue;
...
static void _parse_directory(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
...
static void _parse_paths(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *temp;
    _Ptr<aliases> alias = ((void *)0);
...
static void _parse_logging(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    char *tmp;
    do {
        if (node == NULL) break;
...
static void _parse_security(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
   char *tmp;
   xmlNodePtr oldnode;
...
static void _add_server(xmlDocPtr doc : itype(_Ptr<xmlDoc>), xmlNodePtr node : itype(_Ptr<xmlNode>), _Ptr<ice_config_t> configuration)
{
    _Ptr<ice_config_dir_t> dirnode = ((void *)0);
...
_Ptr<mount_proxy> config_find_mount(_Ptr<ice_config_t> config, const char *mount : itype(_Ptr<const char>), mount_type type)
{
 ...
 * socket
 */
_Ptr<listener_t> config_get_listen_sock(_Ptr<ice_config_t> config, _Ptr<connection_t> con)
{
