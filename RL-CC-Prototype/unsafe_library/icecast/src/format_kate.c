 ...
 */
static _Ptr<refbuf_t> process_kate_page(_Ptr<ogg_state_t> ogg_info, _Ptr<ogg_codec_t> codec, ogg_page *page : itype(_Ptr<ogg_page>))
{
    kate_codec_t *kate = codec->specific;
    ogg_packet packet;
    int header_page = 0;
 ...
 */
_Ptr<ogg_codec_t> initial_kate_page(_Ptr<format_plugin_t> plugin, ogg_page *page : itype(_Ptr<ogg_page>))
{
    ogg_state_t *ogg_info = plugin->_state;
    _Ptr<ogg_codec_t> codec = calloc<ogg_codec_t> (1, sizeof (ogg_codec_t));
    ogg_packet packet;

    kate_codec_t *kate_codec = calloc<kate_codec_t> (1, sizeof (kate_codec_t));
