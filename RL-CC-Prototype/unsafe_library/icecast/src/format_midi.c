...
static _Ptr<refbuf_t> process_midi_page(_Ptr<ogg_state_t> ogg_info, _Ptr<ogg_codec_t> codec, ogg_page *page : itype(_Ptr<ogg_page>))
{
...
_Ptr<ogg_codec_t> initial_midi_page(_Ptr<format_plugin_t> plugin, ogg_page *page : itype(_Ptr<ogg_page>))
{
