...
typedef _Ptr<int (void * compare_arg, void * a, void * b)> avl_key_compare_fun_type;
typedef _Ptr<int (void * key, void * iter_arg)> avl_iter_fun_type;
typedef _Ptr<int (unsigned long index, void * key, void * iter_arg)> avl_iter_index_fun_type;
typedef _Ptr<int (void * key)> avl_free_key_fun_type;
typedef _Ptr<int (char * : itype(_Ptr<char>), void *)> avl_key_printer_fun_type;
...
int avl_get_by_key (_Ptr<avl_tree> tree, void *        key, void **        value_address);

int avl_iterate_inorder (_Ptr<avl_tree> tree, avl_iter_fun_type iter_fun, void *        iter_arg);

int avl_iterate_index_range (_Ptr<avl_tree> tree, avl_iter_index_fun_type iter_fun, unsigned long        low, unsigned long        high, void *        iter_arg);

int avl_get_span_by_key (_Ptr<avl_tree> tree, void *        key, _Ptr<unsigned long> low, _Ptr<unsigned long> high);

int avl_get_span_by_two_keys (_Ptr<avl_tree> tree, void *        key_a, void *        key_b, _Ptr<unsigned long> low, _Ptr<unsigned long> high);
...
int avl_get_item_by_key_most (_Ptr<avl_tree> tree, void *        key, void **        value_address);

int avl_get_item_by_key_least (_Ptr<avl_tree> tree, void *        key, void **        value_address);
