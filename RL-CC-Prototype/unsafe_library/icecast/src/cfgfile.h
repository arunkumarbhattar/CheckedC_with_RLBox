...
typedef struct _config_options {
    char *name;
    char *value;
    _Ptr<struct _config_options> next;
} config_options_t;
...
typedef struct _mount_proxy {
    ...
    _Ptr<ice_config_http_header_t> http_headers; /* additional HTTP headers */

    char *auth_type; /* Authentication type */
    _Ptr<struct auth_tag> auth;
    char *cluster_password;
    _Ptr<config_options_t> auth_options; /* Options for this type */
    char *on_connect;
    char *on_disconnect;
